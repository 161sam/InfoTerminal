...
class UserJourneyTracker {
  ...
  trackWorkflowCompletion(workflowName: string) {
    ...
    this.trackAction({
      ...
      metadata: {
        ...
        totalSteps: this.session.actions.filter(a => 
          a.metadata?.workflowName === workflowName
        ).length
      }
    });
  }
  ...
  trackWorkflowAbandonment(workflowName: string, step: string) {
    ...
    this.trackAction({
      ...
      metadata: {
        ...
        completedSteps: this.session.actions.filter(a => 
          a.metadata?.workflowName === workflowName
        ).length
      }
    });
  ...
  static useUserJourney() {
    ...
    const trackWorkflowStep = useCallback((workflowName: string, step: string) => {
      tracker.trackAction({

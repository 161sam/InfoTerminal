                ...
                <div className="space-y-2">
                  {items.length === 0 ? (
                    <div className="text-center py-8 text-gray-500 dark:text-slate-400">
                      ...
                      <p className="text-sm">
                        Add documents, entities, or graph nodes to build your dossier
                      </p>
                    </div>
                  ) : (
                    items.map((item) => {
                        ...
                        >
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="flex items-center gap-2 mb-1">
                              <span
                                className={`px-2 py-1 text-xs font-medium rounded-full ${getItemTypeColor(item.type)}`}
                              >
                                {item.type}
                              </span>
                ...
                <div className="space-y-3">
                  {[
                    ...
                    },
                    {
                      ...
                      description: "Add chronological timeline",
                    },
                    {
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-medium text-gray-900 dark:text-slate-100">
                    {items.length > 0
                      ? Math.round(
                          (items.reduce((sum, item) => sum + (item.metadata?.confidence || 0), 0) /
                            items.length) *
                            100,
                        )
                      : 0}

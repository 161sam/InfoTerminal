...
function setupMatchMedia(matches: boolean) {
  const mql: any = {
    ...
    onchange: null,
    addEventListener: function (_: string, cb: any) { this._cb = cb; },
    removeEventListener: function () { this._cb = null; },
    dispatch: function (matchesNext: boolean) { this.matches = matchesNext; this._cb?.({ matches: matchesNext }); },
  };
  // @ts-ignore

...
export const DOMAIN_COLORS = {
  ...
  purple: 'bg-purple-50 text-purple-800 border-purple-200 hover:bg-purple-100 dark:bg-purple-900/20 dark:border-purple-900/30 dark:text-purple-300',
  green: 'bg-green-50 text-green-800 border-green-200 hover:bg-green-100 dark:bg-green-900/20 dark:border-green-900/30 dark:text-green-300',
  indigo: 'bg-indigo-50 text-indigo-800 border-indigo-200 hover:bg-indigo-100 dark:bg-indigo-900/20 dark:border-indigo-900/30 dark:text-indigo-300',

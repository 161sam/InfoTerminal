    ...
    <Panel title="Stance Classification" className={className}>
      <div className="space-y-6">
        ...
        <div className="space-y-4">
          ...
          <div>
            <label className={`${textStyles.body} font-medium`}>
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                ...
                <span
                  className={`${getStanceColor(result.stance)} px-3 py-1 rounded-full text-sm font-medium uppercase`}
                >
                  {result.stance}
                </span>
              </div>
            ...
            {/* Main Result Card */}
            <div
              className={`${cardStyles.base} ${cardStyles.padding} bg-gray-50 dark:bg-gray-900/20`}
            >
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-right">
                    ...
                    <p className={textStyles.bodySmall}>{(result.confidence * 100).toFixed(1)}%</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span
                    className={`${statusStyles.info} px-2 py-1 rounded text-sm font-medium capitalize`}
                  >
              ...
              <div className="space-y-2">
                ...
                <div className="flex flex-wrap gap-2">
                  {result.key_phrases.map((phrase, index) => (
                    <span
                      key={index}
                      className={`${statusStyles.neutral} px-2 py-1 rounded text-sm`}
                    >
                      {phrase}
                    </span>
                  ))}
              ...
              <div className="grid grid-cols-2 gap-2">
                <div className="flex items-center gap-1">
                  ...
                  <span className={textStyles.bodySmall}>
                    <strong>Support:</strong> Evidence confirms the claim
                  </span>
                </div>
                <div className="flex items-center gap-1">
                  <XCircle className="h-3 w-3 text-red-500" />
                  <span className={textStyles.bodySmall}>
                    <strong>Contradict:</strong> Evidence refutes the claim
                  </span>
                </div>
                <div className="flex items-center gap-1">
                  <Minus className="h-3 w-3 text-yellow-500" />
                  <span className={textStyles.bodySmall}>
                    <strong>Neutral:</strong> Evidence is neither for nor against
                  </span>
                </div>
                <div className="flex items-center gap-1">

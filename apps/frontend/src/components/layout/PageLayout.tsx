  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
        ...
        {/* Main Content */}
        <main className={`${maxWidthClasses[maxWidth]} mx-auto ${padding ? 'px-4 sm:px-6 lg:px-8' : ''} ${className}`}>
          {/* Breadcrumbs */}
  ...
  return (
    <PageLayout {...layoutProps} maxWidth="full" padding={false}>
      <div className="flex h-full">
        {/* Sidebar */}
        {sidebar && (
          <aside className={`${sidebarWidths[sidebarWidth]} flex-shrink-0 border-r border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800`}>

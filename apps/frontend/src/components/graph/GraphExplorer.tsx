...
export default function GraphExplorer() {
  ...
  const expandGraph = async (nodeId: string, limit: number = 50) => {
    ...
    try {
      const response = await fetch(
        `${GRAPH_API_BASE}/neighbors?node_id=${encodeURIComponent(nodeId)}&limit=${limit}`,
      );
  ...
  const filteredElements = useMemo(() => {
    ...
    return elements.filter((el) => {
      ...
      return (
        el.data.label?.toLowerCase().includes(searchQuery.toLowerCase()) ||
    ...
    <div className="flex flex-col h-screen bg-gray-50">
      ...
      <div className="flex flex-1 overflow-hidden">
            ...
            <div className="space-y-4">
              <div>
                <label className="flex items-center">
                  <input
                    ...
                    onChange={(e) =>
                      setConfig((prev) => ({ ...prev, showLabels: e.target.checked }))
                    }
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setConfig((prev) => ({ ...prev, nodeSize: parseInt(e.target.value) }))
                  }
                  className="w-full"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setConfig((prev) => ({ ...prev, edgeWidth: parseInt(e.target.value) }))
                  }
                  className="w-full"
                />
              </div>
        ...
        <div className="flex-1 relative bg-white dark:bg-gray-950">
          ...
          <div
            className="absolute top-4 right-4 rounded-lg shadow-lg p-2 border
                 bg-white dark:bg-gray-900
          ...
          {selectedNode && (
            <div
              className="absolute bottom-4 left-4 rounded-lg shadow-lg p-4 border
                 bg-white dark:bg-gray-900
            ...
            >
              ...
              <div className="text-sm space-y-1">
                ...
                <div>
                  <span className="text-gray-600">Type:</span> <span>Entity</span>
                </div>

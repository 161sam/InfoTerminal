  ...
  return (
    <div className="space-y-2">
      <div className="flex gap-2">
        <button onClick={() => run("degree")} className="px-2 py-1 border rounded">
          Degree
        </button>
        <button onClick={() => run("betweenness")} className="px-2 py-1 border rounded">
          Betweenness
        </button>
        <button onClick={() => run("louvain")} className="px-2 py-1 border rounded">
          Louvain
        </button>
        {badge()}
      </div>

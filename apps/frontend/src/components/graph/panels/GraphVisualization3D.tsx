...
export default function GraphVisualization3D({ graphData }: GraphVisualization3DProps) {
  ...
  if (loading) {
    return <LoadingSpinner layout="card" text="Loading 3D Components" subText="Initializing deck.gl visualization" />;
  }
  ...
  return (
    <Panel title="3D Graph Visualization">
      <div className="space-y-4">
        ...
        <div style={{ height: 500 }} className="border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden">
          {ScatterplotLayer ? (

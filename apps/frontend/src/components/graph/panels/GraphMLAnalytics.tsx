      ...
      <Panel title="PageRank Centrality">
        <div className="space-y-4">
          <div className="flex items-center gap-2">
            <Button onClick={runPR} disabled={loading} className="inline-flex items-center gap-2">
              {loading ? <LoadingSpinner size="sm" text="" /> : <BarChart3 size={16} />}
              Run PageRank
            </Button>
      ...
      <Panel title="Node2Vec Embeddings">
        <div className="space-y-4">
          <div className="flex items-center gap-2">
            ...
            >
              {loading ? <LoadingSpinner size="sm" text="" /> : <Brain size={16} />}
              Run Node2Vec
            </Button>
            <span className="text-sm text-gray-500 dark:text-slate-400">

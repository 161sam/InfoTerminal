      ...
      {centralityData.length > 0 && (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <Card>
            <CardHeader>
              <CardTitle>
                Top Nodes by {centralityType === "degree" ? "Degree" : "Betweenness"}
              </CardTitle>
            </CardHeader>
            <CardContent>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            ...
            Graph Overview
            <Button variant="outline" size="sm" onClick={fetchGraphSummary} disabled={loading}>
              {loading ? (
                <RefreshCw className="h-4 w-4 animate-spin" />
              ) : (
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
              <div className="text-center">
                <div className="text-2xl font-bold text-blue-600">
                  {graphSummary.total_nodes.toLocaleString()}
                </div>
                <div className="text-sm text-gray-600">Total Nodes</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-green-600">
                  {graphSummary.total_relationships.toLocaleString()}
                </div>
                <div className="text-sm text-gray-600">Relationships</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-purple-600">
                  {graphSummary.node_types.length}
                </div>

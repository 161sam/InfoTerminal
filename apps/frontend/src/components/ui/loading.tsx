...
const containerVariants = cva("", {
  variants: {
    layout: {
      ...
      overlay:
        "absolute inset-0 flex items-center justify-center bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm",
...
export function ErrorState({
  ...
  return (
    ...
    >
      ...
      <h3 className={cn("text-lg font-semibold mb-2", style.container)}>{title}</h3>

      <p className="text-gray-600 dark:text-gray-400 text-center mb-4 max-w-md">{message}</p>

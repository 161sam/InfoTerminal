...
function DialogTitle({ className = "", ...props }: DialogTitleProps) {
  return <h2 className={`text-lg font-semibold text-gray-900 dark:text-slate-100 ${className}`} {...props} />;
}
...
function DialogTrigger({ className = "", children, onClick, ...props }: DialogTriggerProps) {
  ...
  const baseClasses = "inline-flex items-center justify-center rounded-md border border-gray-300 bg-white px-3 py-2 text-sm text-gray-900 shadow-sm hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-primary-500 dark:border-gray-700 dark:bg-gray-900 dark:text-slate-100 dark:hover:bg-gray-800";
...
export { Dialog, DialogContent, DialogHeader, DialogTitle, DialogBody, DialogFooter, DialogTrigger };

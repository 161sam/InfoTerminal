...
import { Container, HardDrive, Clock, Activity, RefreshCw, Trash2 } from "lucide-react";
    ...
    return (
      <Card className={className}>
        <CardContent className="p-6">
          <div className="text-center text-muted-foreground">No active incognito session</div>
        </CardContent>
      </Card>
    );
  }
      ...
      <CardContent className="space-y-4">
        {containers.length === 0 ? (
          <Alert>
            ...
            <AlertDescription>No ephemeral containers found for this session.</AlertDescription>
          </Alert>
        ) : (
          <div className="space-y-3">
            {containers.map((container) => (
              <div key={container.id} className="p-4 border rounded-lg space-y-3">
                <div className="flex items-center justify-between">
                ...
                <div className="grid grid-cols-3 gap-4 text-sm">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span>
                      Memory: {formatMemoryUsage(container.memoryUsage)} /{" "}
                      {formatMemoryUsage(container.memoryLimit)}
                    </span>
                  </div>
                  <div className="flex items-center gap-2">
          ...
          <div className="grid grid-cols-3 gap-4 text-sm">
            ...
            <div>
              ...
              <p className="text-lg font-medium">
                {formatMemoryUsage(containers.reduce((sum, c) => sum + c.memoryUsage, 0))}
              </p>
            </div>
          </div>
        </div>

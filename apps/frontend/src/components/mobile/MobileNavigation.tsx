                ...
                return (
                  <div key={item.key} className="space-y-1">
                    ...
                    <div className="flex items-center">
                      <button
                        onClick={() => hasSubItems ? toggleExpanded(item.key) : handleNavigation(item.href)}
            ...
            return (
              ...
              >
                ...
                <span className="text-xs font-medium truncate">
                  {item.name === 'Graph Analysis' ? 'Graph' : 
                   item.name === 'NLP Analysis' ? 'NLP' :
                   item.name === 'AI Agents' ? 'Agents' : 
                   item.name}
                </span>
                {item.badge && (

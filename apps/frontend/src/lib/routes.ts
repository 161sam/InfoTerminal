...
export const externalApps: Record<ExternalAppKey, {
  label: string; env: string; path: string;
}> = {
  ...
  prometheus: { label: "Prometheus", env: "NEXT_PUBLIC_APP_PROMETHEUS_URL", path: "/apps/prometheus" },
};

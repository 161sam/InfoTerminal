...
const runCompleteDiagnosis = () => {
  ...
  setTimeout(() => {
    ...
    console.log("\n💡 Nächste Schritte:");
    console.log(
      "1. Wenn manueller Toggle funktioniert, aber Button nicht -> Event Handler Problem",
    );
    console.log("2. Wenn gar nichts funktioniert -> CSS/Tailwind Problem");
    console.log(
      "3. Wenn Button klick registriert wird, aber Theme nicht ändert -> ThemeProvider Problem",
    );

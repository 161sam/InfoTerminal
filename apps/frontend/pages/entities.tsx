          ...
          <div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-900/30">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-blue-800 dark:text-blue-300">{entityStats.total}</p>
              </div>
          ...
          <div className="p-4 bg-green-50 dark:bg-green-900/20 rounded-lg border border-green-200 dark:border-green-900/30">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-green-800 dark:text-green-300">{entityStats.verified}</p>
              </div>
          ...
          <div className="p-4 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg border border-yellow-200 dark:border-yellow-900/30">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-yellow-800 dark:text-yellow-300">{entityStats.pending}</p>
              </div>
          ...
          <div className="p-4 bg-red-50 dark:bg-red-900/20 rounded-lg border border-red-200 dark:border-red-900/30">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-red-800 dark:text-red-300">{entityStats.highRisk}</p>
              </div>
          ...
          <div className="p-4 bg-purple-50 dark:bg-purple-900/20 rounded-lg border border-purple-200 dark:border-purple-900/30">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-purple-800 dark:text-purple-300">{entityStats.newToday}</p>
              </div>
          ...
          <div className="p-4 bg-indigo-50 dark:bg-indigo-900/20 rounded-lg border border-indigo-200 dark:border-indigo-900/30">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-indigo-800 dark:text-indigo-300">{entityStats.totalConnections}</p>
              </div>
            ...
            <Panel>
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between text-sm text-gray-600 dark:text-slate-400">
                  <span>Showing {sortedEntities.length} of {entities.length} entities</span>
                  {(filters.searchTerm || filters.type !== 'all' || filters.verified !== 'all' || filters.riskLevel !== 'all' || filters.minMentions > 0) && (
              ...
              {sortedEntities.length === 0 && (
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-500 dark:text-slate-400">
                    {filters.searchTerm || filters.type !== 'all' ? 'Try adjusting your search filters' : 'Upload documents to start detecting entities'}
                  </p>
                </div>
              )}
            </div>
              ...
              <div className="space-y-3">
                {Object.entries(
                  ...
                  return (
                    <button
                      key={type}
                      onClick={() => setFilters(prev => ({ ...prev, type: type === filters.type ? 'all' : type }))}
...
function EntityCard({ entity, onAction }: { entity: Entity; onAction: (entity: Entity, action: string) => void }) {
        ...
        <div className="flex-1 min-w-0">
            ...
            <div>
              ...
              <div className="flex items-center gap-2 mb-2">
                ...
                {entity.riskScore !== undefined && entity.riskScore > 0 && (
                  <span className={`px-2 py-1 rounded-full text-xs font-medium ${getRiskColor(entity.riskScore)}`}>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
            <div>
              ...
              <div className="font-semibold text-gray-900 dark:text-slate-100">{entity.mentions}</div>
            </div>
            <div>
              <span className="text-gray-500 dark:text-slate-400">Confidence</span>
              <div className="font-semibold text-gray-900 dark:text-slate-100">{Math.round(entity.confidence * 100)}%</div>
            </div>
            <div>
              <span className="text-gray-500 dark:text-slate-400">Sources</span>
              <div className="font-semibold text-gray-900 dark:text-slate-100">{entity.sources.length}</div>
            </div>
            <div>
              <span className="text-gray-500 dark:text-slate-400">Connections</span>
              <div className="font-semibold text-gray-900 dark:text-slate-100">{entity.connections || 0}</div>
            </div>
          </div>
...
function EntityDetailPanel({ entity, onClose, onUpdate }: {
  entity: Entity;
  onClose: () => void;
  ...
  return (
    <Panel>
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          <h3 className="text-lg font-semibold text-gray-900 dark:text-slate-100">Entity Details</h3>
          <button
            onClick={onClose}
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            {isEditing ? (
              ...
              <p className="text-gray-900 dark:text-slate-100">{entity.description || 'No description'}</p>
            )}
          </div>

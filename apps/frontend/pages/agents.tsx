        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <Card>
            <CardContent className="flex items-center justify-between p-6">
              ...
              <div className={`p-3 rounded-full ${
                multiAgentEnabled ? 'bg-green-100' : 'bg-gray-100'
              }`}>
                <Users className={`h-5 w-5 ${
                  multiAgentEnabled ? 'text-green-600' : 'text-gray-400'
                }`} />
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardContent className="flex items-center justify-between p-6">
              ...
              <div className={`p-3 rounded-full ${
                workflowsEnabled ? 'bg-purple-100' : 'bg-gray-100'
              }`}>
                <Zap className={`h-5 w-5 ${
                  workflowsEnabled ? 'text-purple-600' : 'text-gray-400'
                }`} />
              </div>
            </CardContent>
          </Card>
                  ...
                  <Card key={capability.id} className="hover:shadow-md transition-shadow">
                    <CardContent className="p-6">
                      <div className="flex items-start gap-4">
                        <div className={`p-3 rounded-lg ${CAPABILITY_COLORS[capability.color as keyof typeof CAPABILITY_COLORS]}`}>

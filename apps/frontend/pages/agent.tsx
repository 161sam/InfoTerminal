...
import { AgentChatPanel, AgentManagementPanel } from "@/components/agents/panels";
...
export default function ConsolidatedAgentPage() {
  ...
  if (!agentEnabled) {
    return (
      <DashboardLayout title="Agent Platform" subtitle="AI agent services are currently disabled">

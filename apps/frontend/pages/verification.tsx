            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                <Panel>
                  <div className="flex items-center justify-between mb-2">
                    <div className="text-sm text-gray-500 dark:text-slate-400">Claims Extracted</div>
                    <Search className="h-4 w-4 text-blue-500" />
                  </div>
                  <div className="text-2xl font-bold text-primary-600 dark:text-primary-400">{verificationStats.totalClaims}</div>
                  <div className="text-sm text-gray-500 dark:text-slate-400">From analyzed text</div>
                </Panel>

                <Panel>
                  <div className="flex items-center justify-between mb-2">
                    <div className="text-sm text-gray-500 dark:text-slate-400">Evidence Sources</div>
                    <Target className="h-4 w-4 text-green-500" />
                  </div>
                  <div className="text-2xl font-bold text-green-600 dark:text-green-400">{verificationStats.evidenceSources}</div>
                  <div className="text-sm text-gray-500 dark:text-slate-400">Retrieved for verification</div>
                </Panel>
                ...
                <Panel>
                  ...
                  <div className="text-2xl font-bold text-purple-600 dark:text-purple-400">{verificationStats.stanceAnalyses}</div>
                  <div className="text-sm text-gray-500 dark:text-slate-400">Completed classifications</div>
                </Panel>

                <Panel>
                  <div className="flex items-center justify-between mb-2">
                    <div className="text-sm text-gray-500 dark:text-slate-400">Credibility Checks</div>
                    <Shield className="h-4 w-4 text-orange-500" />
                  </div>
                  <div className="text-2xl font-bold text-orange-600 dark:text-orange-400">{verificationStats.credibilityChecks}</div>
                  <div className="text-sm text-gray-500 dark:text-slate-400">Source assessments</div>
                </Panel>
              </div>
              ...
              <Panel>
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h3 className={`${textStyles.h3} text-primary-600 dark:text-primary-400`}>InfoTerminal v0.2.0 Verification Features</h3>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                  <div className={`${cardStyles.base} p-4`}>
                    ...
                    <p className={textStyles.body}>Automatically extract verifiable claims from text using advanced NLP models</p>
                  </div>
                  ...
                  <div className={`${cardStyles.base} ${cardStyles.padding}`}>
                    ...
                    <p className={textStyles.body}>Find supporting evidence from multiple sources including web, news, and academic papers</p>
                  </div>
                  ...
                  <div className={`${cardStyles.base} ${cardStyles.padding}`}>
                    ...
                    <p className={textStyles.body}>Classify whether evidence supports, contradicts, or is neutral toward claims</p>
                  </div>
                  ...
                  <div className={`${cardStyles.base} ${cardStyles.padding}`}>
                    ...
                    <p className={textStyles.body}>Assess the credibility and bias of information sources automatically</p>
                  </div>
                </div>
              </Panel>
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className={textStyles.bodySmall}>Paste or type text to automatically identify verifiable claims</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className={textStyles.bodySmall}>Search for supporting or contradicting evidence from reliable sources</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className={textStyles.bodySmall}>Analyze whether evidence supports or contradicts the claim</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className={textStyles.bodySmall}>Evaluate the reliability and bias of information sources</p>
                    </div>
                  </div>
                </div>
              </Panel>

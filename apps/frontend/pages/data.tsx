...
const getStatusColor = (status: ImportItem['status']) => {
  switch (status) {
    ...
    case 'processing': return 'text-blue-600 bg-blue-100 dark:bg-blue-900/30 dark:text-blue-300';
...
const getApiEndpoint = (fileType: ImportItem['fileType']) => {
  switch (fileType) {
    case 'document': return '/api/documents/upload';
    case 'image': 
    case 'video': 
    case 'audio': return '/api/forensics/ingest';
    default: return '/api/documents/upload';
  }
};
...
export default function DataPage() {
  ...
  const clearCompleted = useCallback(() => {
    setImports(prev => prev.filter(item => item.status !== 'success' && item.status !== 'error'));
  }, []);
                ...
                <div key={source.id} className="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
                  ...
                  <div className="flex items-center gap-3">
                    <div className="text-right">
                      <div className={`inline-flex items-center gap-1 px-2 py-1 rounded-full text-xs font-medium ${getDataSourceStatusColor(source.status)}`}>
            ...
            <div className="space-y-3">
              ...
              >
                ...
                <div>
                  ...
                  <div className="text-xs text-blue-600 dark:text-slate-400">Upload documents or media files</div>
                </div>
              </button>
        ...
        <Panel padded>
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900 dark:text-slate-100">{stats.processing}</p>
            </div>
        ...
        <Panel padded>
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900 dark:text-slate-100">{stats.completed}</p>
            </div>
